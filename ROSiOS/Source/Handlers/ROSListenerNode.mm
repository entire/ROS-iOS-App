...
{
    th_ = new boost::thread(&ROSListenerNode::spin, this);
    sub_ = nh_.subscribe("chatter", 1000, &ROSListenerNode::chatterCB, this);
}
...
void ROSListenerNode::spin()
{
    ros::spin();
}

void ROSListenerNode::chatterCB(const std_msgs::String::ConstPtr &msg)
{
